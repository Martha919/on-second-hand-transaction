...
Page({
  ...
  */
  onShow: function () {
    var that = this
    wx.request({//调用wx.request()，
      url: 'https://www.parcruz.site/api/face' + '/goods/class',//请求地址
      success: function (res) {
        that.setData({//调用setData，修改this.data的值
  ...
  formSubmit: function (e) {
    ...
    if (value.name == "") {
      ...
      console.log("userId=" + app.data.userInfo.id +
        ...
        " price=" + value.price)
      wx.request({
        url: www.parcruz.site/api/face + '/goods/add',
        method: 'POST',
        header: {
